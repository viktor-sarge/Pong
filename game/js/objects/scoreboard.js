...
export default class Scoreboard {
    ...
    draw(ctx, canvas) {
        ...
        ctx.fillText(this.scores.p1, canvas.width / 4, this.config.TEXT_SETTINGS.SCOREBOARD.Y_POSITION);
        ctx.fillText(this.scores.p2, (canvas.width / 4) * 3, this.config.TEXT_SETTINGS.SCOREBOARD.Y_POSITION);
    }
